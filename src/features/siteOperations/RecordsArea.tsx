          ...
          <>
            ...
            {r.structuredSummary ? (
              <div className="so-tab-section">
                ...
                <p style={{ color: "#374151", fontSize: 13, lineHeight: 1.6, margin: 0, background: "#F9FAFB", padding: "10px 14px", borderRadius: 8, border: "1px solid #E5E7EB" }}>{r.structuredSummary}</p>
              </div>
            ) : null}
