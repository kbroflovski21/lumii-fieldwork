...
这是当前产品设计文档入口。新 session 先按 0/1/2/3 顺序读，不要从旧草稿开始。

| 编号 | 文档 | 用途 |
| --- | --- | --- |
| 0 | [`agentic-design-methodology.md`](agentic-design-methodology.md) | 方法论：怎么从业务流走到 UI / Chat context |
...
- [`system-use-cases.md`](system-use-cases.md)
- [`ui-interaction-model.md`](ui-interaction-model.md)
- [`role-interaction-flow-spec.md`](role-interaction-flow-spec.md)
