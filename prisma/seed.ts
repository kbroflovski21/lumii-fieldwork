...
async function main() {
  ...
  await prisma.serviceObject.createMany({
    data: [
      ...
      { id: "object-003", name: "王奶奶", phone: "13700009999", age: 88, gender: "female", address: "上海市杨浦区国顺路 500 号", mapDisplayPoint: null, eligibilityType: "self_paid", serviceFrequency: "每周一次", serviceProjects: ["探访关爱"], riskTags: [], careNotes: [], familySubscriptionSummary: "monthly", latestInsightSummary: null, insightSummaries: [], state: "normal" },
    ],
  });
