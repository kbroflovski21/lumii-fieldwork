...
async function main() {
  ...
  await prisma.serviceObject.createMany({
    data: [
      ...
      { id: "object-003", name: "王奶奶", phone: "13700009999", age: 88, gender: "female", address: "杭州市西湖区古荡新村12幢", siteId: "site-003", eligibilityType: "self_paid", serviceFrequency: "每周一次", serviceProjects: ["探访关爱"], riskTags: [], careNotes: [], familySubscriptionSummary: "monthly", latestInsightSummary: null, insightSummaries: [], state: "normal" },
    ],
  });
