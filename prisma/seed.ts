...
async function main() {
  ...
  await prisma.socialWorker.createMany({
    data: [
      ...
      { id: "worker-003", userId: "user-003", name: "李芳", phone: "13900000003", siteId: "site-002", workerType: "service_personnel", qualificationLabels: ["助餐"], status: "incomplete_profile", preferredBadgeId: "badge-030", preferredBadgeDeviceCode: "FW-030", preferredBadgeStatus: "pending_activation", praiseCount: 3 },
      { id: "worker-004", userId: "user-004", name: "周建国", phone: "13700000004", siteId: "site-002", workerType: "service_personnel", qualificationLabels: [], status: "disabled", praiseCount: 0 },
    ],
  });
  ...
  await prisma.smartBadge.createMany({
    data: [
      { id: "badge-021", deviceCode: "FW-021", orgId: "org-001", siteId: "site-001", siteName: "翠苑站", status: "available", batteryPercent: 83, activatedAt: "2026-05-01T09:00:00+08:00", lastSyncAt: "2026-05-13T08:50:00+08:00", lastRecordingAt: "2026-05-12T10:22:00+08:00", preferredWorkerId: "worker-001", preferredWorkerName: "王丽", recentServiceRecordIds: ["record-001"] },
      { id: "badge-026", deviceCode: "FW-026", orgId: "org-001", siteId: "site-001", siteName: "翠苑站", status: "sync_delayed", batteryPercent: 92, activatedAt: "2026-05-03T09:00:00+08:00", lastSyncAt: "2026-05-12T18:43:00+08:00", recentServiceRecordIds: [] },
      { id: "badge-030", deviceCode: "FW-030", orgId: "org-001", siteId: "site-002", siteName: "三墩站", status: "pending_activation", recentServiceRecordIds: [] },
      { id: "badge-031", deviceCode: "FW-031", orgId: "org-001", siteId: "site-001", siteName: "翠苑站", status: "in_use", batteryPercent: 67, activatedAt: "2026-05-02T10:00:00+08:00", lastSyncAt: "2026-05-14T09:30:00+08:00", lastRecordingAt: "2026-05-14T09:35:00+08:00", preferredWorkerId: "worker-002", preferredWorkerName: "张敏", recentServiceRecordIds: ["record-001"] },
      { id: "badge-032", deviceCode: "FW-032", orgId: "org-001", siteId: "site-002", siteName: "三墩站", status: "offline", batteryPercent: 45, activatedAt: "2026-04-20T09:00:00+08:00", lastSyncAt: "2026-05-11T14:20:00+08:00", recentServiceRecordIds: [] },
      { id: "badge-033", deviceCode: "FW-033", orgId: "org-001", siteId: "site-002", siteName: "三墩站", status: "low_battery", batteryPercent: 8, activatedAt: "2026-04-15T09:00:00+08:00", lastSyncAt: "2026-05-14T07:10:00+08:00", preferredWorkerId: "worker-003", preferredWorkerName: "李芳", recentServiceRecordIds: [] },
      { id: "badge-034", deviceCode: "FW-034", orgId: "org-001", siteId: "site-003", siteName: "古荡站", status: "disabled", batteryPercent: 55, activatedAt: "2026-03-01T09:00:00+08:00", lastSyncAt: "2026-04-30T16:00:00+08:00", recentServiceRecordIds: [] },
      { id: "badge-035", deviceCode: "FW-035", orgId: "org-001", siteId: "site-003", siteName: "古荡站", status: "lost", batteryPercent: 30, activatedAt: "2026-03-10T09:00:00+08:00", lastSyncAt: "2026-05-05T11:00:00+08:00", recentServiceRecordIds: [] },
    ],
  });
  ...
  await prisma.serviceObject.createMany({
    data: [
      { id: "object-001", name: "陈阿姨", phone: "13800001234", age: 82, gender: "female", address: "杭州市西湖区翠苑街道翠苑一区3幢", siteId: "site-001", mapDisplayPoint: { latitude: 30.287, longitude: 120.127, label: "翠苑一区3幢" }, eligibilityType: "government", serviceFrequency: "每周三次", serviceProjects: ["长护险"], riskTags: ["独居", "跌倒风险"], careNotes: ["午餐后需确认服药"], familySubscriptionSummary: "weekly", latestInsightSummary: "最近三次助餐完成稳定，需关注用药提醒。", insightSummaries: [{ id: "insight-001", title: "状态稳定", description: "最近三次服务均按时完成。", severity: "info" }, { id: "insight-002", title: "用药提醒", description: "午餐后需确认服药。", severity: "warning" }], state: "plan_exception_active" },
      { id: "object-002", name: "李爷爷", phone: "13900005678", age: 78, gender: "male", address: "杭州市西湖区三墩镇振华路88号", siteId: "site-002", mapDisplayPoint: { latitude: 30.330, longitude: 120.083, label: "振华路88号" }, eligibilityType: "insurance", serviceFrequency: "每周两次", serviceProjects: ["长护险"], riskTags: ["认知障碍"], careNotes: ["需要家属陪同助浴", "对水温敏感"], familySubscriptionSummary: "none", latestInsightSummary: null, insightSummaries: [], state: "plan_paused" },
      { id: "object-003", name: "王奶奶", phone: "13700009999", age: 88, gender: "female", address: "杭州市西湖区古荡新村12幢", siteId: "site-003", eligibilityType: "self_paid", serviceFrequency: "每周一次", serviceProjects: ["长护险"], riskTags: [], careNotes: [], familySubscriptionSummary: "monthly", latestInsightSummary: null, insightSummaries: [], state: "normal" },
    ],
  });
